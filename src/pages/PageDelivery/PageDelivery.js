    ...
    return (
        <div className={classes.deliveryMap_module}>
            <div className={classes.deliveryMap_module__wrapper}>
                ...
                <div className={classes.deliveryMap_module_time}><p className={classes.deliveryMap_module_time_par}> ВС-ЧТ c 10:00 до 23:30. ПТ, СБ с 10:00 - 01:00</p>     </div>
                <iframe
                    ...
                    width="100%" height="551" frameBorder="0"/>
                ...
                <div className={classes.deliveryMap_module__order}>
                    <div className={classes.deliveryMap_module__order_block}>
                        ...
                        <p className={classes.deliveryMap_module__order_txt2}>Вы оплачиваете только заказ, в красной
                            зоне
                            доставка бесплатно от 1000 руб.</p>
                    ...
                    <div className={classes.deliveryMap_module__order_block}>
                        ...
                        <p className={classes.deliveryMap_module__order_txt2}>Укажите время, к которому вы хотите
                            получить
                            заказ, и мы доставим его точно в срок.</p>
                    </div>
                    <div className={classes.deliveryMap_module__order_block}>
                        <img src={del_bag} alt={''}/>
                        <p className={classes.deliveryMap_module__order_txt}>С СОБОЙ СО СКИДКОЙ 10%.</p>
                        <p className={classes.deliveryMap_module__order_txt2}>Вы можете сами забрать заказ из ближайшего
                            ресторана со скидкой 10% (Кроме праздничных дней).</p>
                    </div>
                </div>
                ...
                <div className={classes.deliveryMap_module__delivery}>
                    <div className={classes.deliveryMap_module__order_block}>
                        ...
                        <p className={classes.deliveryMap_module__order_txt2}>ВС-ЧТ c 10:00 до 23:30. ПТ, СБ с 10:00 -
                            01:00.</p>
                    </div>
                    <div className={classes.deliveryMap_module__order_block}>
                        <img src={del_map} alt={''}/>
                    ...
                    <div className={classes.deliveryMap_module__order_block}>
                        ...
                        <p className={classes.deliveryMap_module__order_txt2}>Заказы от 1000 руб. в красной зоне
                            доставляются бесплатно, вы оплачиваете только заказ</p>
                    </div>
                    <div className={classes.deliveryMap_module__order_block}>
                        <img src={del_like} alt={''}/>
                        <p className={classes.deliveryMap_module__order_txt}>ПЛАТНАЯ ДОСТАВКА</p>
                        <p className={classes.deliveryMap_module__order_txt2}>Доставка в зеленую зону карты доставки,
                            осуществляется при заказе от 1300 рублей и дополнительно оплачивается доставка 150
                            рублей.</p>
                    </div>
                    <div className={classes.deliveryMap_module__order_block}>
                        <img src={del_cart} alt={''}/>
                        <p className={classes.deliveryMap_module__order_txt}>МИНИМАЛЬНАЯ СУММА ЗАКАЗА — 500 РУБ*.</p>
                        <p className={classes.deliveryMap_module__order_txt}>ЗАКАЗ ОТ 500₽ ДО 1000 ₽ - СТОИМОСТЬ
                            ДОСТАВКИ 95
                            ₽</p>
                    ...
                    <div className={classes.deliveryMap_module__order_block}>
                        ...
                        <p className={classes.deliveryMap_module__order_txt2}>Время доставки необходимо уточнять у
                            оператора</p>
                    </div>
                </div>
            </div>
